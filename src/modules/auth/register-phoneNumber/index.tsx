...
const index = ({
  ...
  return (
    <div className="w-full h-screen flex bg-white flex-col items-start lg:items-center lg:justify-between gap-10 lg:gap-4 px-3 py-4">
        <div className='w-full lg:w-[50%] flex flex-col items-start lg:items-center justify-between lg:justify-center gap-1 p-1'>
            <Jivee />
        ...
        <div className='w-full lg:w-[50%] h-screen flex flex-col items-start lg:items-center justify-start gap-1 px-1 lg:px-3 py-3 lg:py-14'>
          <div className='flex flex-col gap-3'>
            ...
            <div className='flex flex-row gap-1 items-center'>
                ...
                <DefaultInput height='44px' name='phoneNumber' value={details.phoneNumber} type='number' shadow='md' onBlur={handleBlur} bgColor='purple.300' onChange={handleChange} focusBorderColor='purple.500' />
            </div>
