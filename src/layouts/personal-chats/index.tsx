...
const index = () => {
  ...
  // const emojiPickerTop = useMemo(() => ['10px', '25px', '50px', '65px', '75px', '75px'], []);
  // const emojiPickerLeft = useMemo(() => ['0px', '0px', '0px', '0px', '0px', '70px'], []);
  ...
  return (
    <div className="w-full flex flex-col items-center justify-start gap-1 h-full" >
      <div className="w-full flex items-center justify-center">
        <DefaultInput height='34px' name='search' value={searchValue} /* showAttachIcon={false} emojiPickerResponsive={true} emojiPickerTop={emojiPickerTop} emojiPickerLeft={emojiPickerLeft}n*/ type='search' color="purple.500" shadow='md' onBlur={handleBlur} bgColor='purple.100' width='80%' onChange={handleChange} focusBorderColor='purple.500' className='flex items-center mx-auto focus-within:bg-white fixed text-base' />
      </div>
